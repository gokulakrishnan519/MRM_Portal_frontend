...
export default function CreateMaterialRequest(props) {
  ...
  const handleRefreshRow = (indexToRefresh) => {
    setRows((prev) =>
      prev.map((row, index) =>
        index === indexToRefresh
          ? { ...emptyRow(), id: row.id } // keep existing id if needed
          : row,
      ),
    );
  };
                  ...
                  {!isFormValid && (
                    ...
                    >
                      * Please fill all required fields.
                      <br />
                      • For New Material: Material Category, UOM and Quantity
                      are required.
